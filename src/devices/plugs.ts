...
export class Plug {
    ...
    constructor(
      ...
      this.refreshStatus();
        ...
        this.service.setCharacteristic(this.platform.Characteristic.OutletInUse, this.OutletInUse);
      ...
      try {
        ...
        if (deviceStatus.message === 'success') {
          ...
          this.platform.log.warn(
            'Curtain %s refreshStatus - PLEASE POST THIS BACK INTO ISSUE TO GET INFO!',
            this.accessory.displayName,
