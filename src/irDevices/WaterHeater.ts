...
export class WaterHeater {
  ...
  constructor(
    ...
    this.service
      ...
      .on(CharacteristicEventTypes.SET, (value: any, callback: CharacteristicGetCallback) => {
        ...
        this.platform.log.debug('WaterHeater %s Set Active Identifier: %s', this.accessory.displayName, value);
        callback(null);
      });
      ...
      .on(CharacteristicEventTypes.SET, (value: any, callback: CharacteristicGetCallback) => {
        switch (value) {
          case this.platform.Characteristic.RemoteKey.REWIND: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: REWIND', this.accessory.displayName);
            break;
          }
          case this.platform.Characteristic.RemoteKey.FAST_FORWARD: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: FAST_FORWARD', this.accessory.displayName);
            break;
          }
          case this.platform.Characteristic.RemoteKey.NEXT_TRACK: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: NEXT_TRACK', this.accessory.displayName);
            break;
          }
          case this.platform.Characteristic.RemoteKey.PREVIOUS_TRACK: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: PREVIOUS_TRACK', this.accessory.displayName);
            break;
          }
          case this.platform.Characteristic.RemoteKey.ARROW_UP: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: ARROW_UP', this.accessory.displayName);
            //this.pushUpChanges();
            break;
          }
          case this.platform.Characteristic.RemoteKey.ARROW_DOWN: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: ARROW_DOWN', this.accessory.displayName);
            //this.pushDownChanges();
            break;
          }
          case this.platform.Characteristic.RemoteKey.ARROW_LEFT: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: ARROW_LEFT', this.accessory.displayName);
            //this.pushLeftChanges();
            break;
          }
          case this.platform.Characteristic.RemoteKey.ARROW_RIGHT: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: ARROW_RIGHT', this.accessory.displayName);
            //this.pushRightChanges();
            break;
          }
          case this.platform.Characteristic.RemoteKey.SELECT: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: SELECT', this.accessory.displayName);
            //this.pushOkChanges();
            break;
          }
          case this.platform.Characteristic.RemoteKey.BACK: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: BACK', this.accessory.displayName);
            //this.pushBackChanges();
            break;
          }
          case this.platform.Characteristic.RemoteKey.EXIT: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: EXIT', this.accessory.displayName);
            break;
          }
          case this.platform.Characteristic.RemoteKey.PLAY_PAUSE: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: PLAY_PAUSE', this.accessory.displayName);
            break;
          }
          case this.platform.Characteristic.RemoteKey.INFORMATION: {
            this.platform.log.debug('WaterHeater %s Set Remote Key Pressed: INFORMATION', this.accessory.displayName);
    ...
    this.speakerService
      ...
      .on(CharacteristicEventTypes.SET, (value, callback: CharacteristicGetCallback) => {
        this.platform.log.debug('WaterHeater %s Set VolumeSelector: %s', this.accessory.displayName, value);
  ...
  async pushWaterHeaterOnChanges() {
    if (this.Active !== 1) {
      ...
      await this.pushWaterHeaterChanges(payload);
    }
  }
  ...
  public async pushWaterHeaterChanges(payload: any) {
